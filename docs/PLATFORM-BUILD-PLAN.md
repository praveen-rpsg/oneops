...
- [ ] E9 Dashboards (trends over time): incident/alert counts over time, telemetry charts — needs time-bucketed projections (reuse telemetry_rollup_5m + time_bucket). Overlaps E7.3.  ▶ CURRENT
