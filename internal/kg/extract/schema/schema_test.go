...
func TestEveryTableIsANode(t *testing.T) {
	...
	want := []string{
		...
		"audit_chain_head", "audit_event", "audit_event_default", "collector_check", "compliance_control", "configuration_metadata",
...
func TestCorpusCensus(t *testing.T) {
	...
	want := map[string]int{
		kindTable: 52, kindColumn: 499, kindIndex: 107, kindConstraint: 196, kindTrigger: 12,
	}
